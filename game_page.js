...
function send() {
    ...
    console.log(s_letter, m_letter, l_letter);
    replace_word = q_word.replace(s_letter, "_");
    console.log(replace_word);
    replace_word = replace_word.replace(m_letter, "_");
    console.log(replace_word);
    replace_word = replace_word.replace(l_letter, "_");
    console.log(replace_word);
    q_tag = '<h4 id="q_w">q:' + replace_word + '</h4>';
